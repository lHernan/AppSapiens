...
public class ErroresServiceImpl extends ServiceSupport implements ErroresService {
        ...
        try (Connection conn = dataSource.getConnection();
            ...
            if (arrayErrorScripts != null) {
                ...
                for (Object row : rows) {
                    ...
                    ErrorScript errorScript = ErrorScript.builder()
                            .numeroOrden((BigDecimal) cols[0])
                            .fechaError((Date) cols[1])
                            .idProceso((BigDecimal) cols[2])
                            .numeroIteracion((BigDecimal) cols[3])
                            .numeroEjecucion((BigDecimal) cols[4])
                            .nombreScript((String) cols[5])
                            .numeroSentencia((BigDecimal) cols[6])
                            .txtError((String) cols[7])
                            .build();
            ...
            if (arrayScriptParches != null) {
                ...
                for (Object row : rows) {
                    ...
                    ScriptParche errorScript = ScriptParche.builder()
                            .numeroOrden((BigDecimal) cols[0])
                            .codigoEstadoEjecucion((BigDecimal) cols[1])
                            .descripcionEstadoEjecucion((String) cols[2])
                            .fechaScript((Date) cols[3])
                            .idProceso((BigDecimal) cols[4])
                            .numeroIteracion((BigDecimal) cols[5])
                            .numeroEjecucion((BigDecimal) cols[6])
                            .nombreScript((String) cols[7])
                            .txtComentario((String) cols[8])
                            .build();
                    scriptParches.add(errorScript);
                }
            }

            OutputErroresScript outputErroresScript = OutputErroresScript.builder()
                    .listaErroresScript(errorScripts)
                    .listaScriptParche(scriptParches)
                    .build();
    ...
    @Override
    @SneakyThrows
    public List<ErrorScript> consultaErroresType(BigDecimal idProceso, BigDecimal numeroOrden) {
